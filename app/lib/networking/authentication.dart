...
Future<String> signUp(String _email, String _password) async { //Logik för att skapa konto
  try {
...
Future<String> signIn(String _email, String _password) async { //Logik för login.
  try {
